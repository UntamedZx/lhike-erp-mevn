									...
									<div class="direct-chat-messages">
										...
										<div class="direct-chat-msg">
											...
											<img
												...
												src="../assets/admin-lte/img/user1-128x128.jpg"
										...
										<div class="direct-chat-msg end">
											...
											<img
												class="direct-chat-img"
												src="../assets/admin-lte/img/user3-128x128.jpg"
												alt="message user image" />
											<!-- /.direct-chat-img -->
										...
										<ul class="contacts-list">
											...
											<li>
												<a href="#">
													<img
														class="contacts-list-img"
														src="../assets/admin-lte/img/user7-128x128.jpg"
														alt="User Avatar" />
													<div class="contacts-list-info">
														<span class="contacts-list-name">
															Sarah Doe
											...
											<li>
												<a href="#">
													<img
														class="contacts-list-img"
														src="../assets/admin-lte/img/user5-128x128.jpg"
														alt="User Avatar" />
													<div class="contacts-list-info">
														<span class="contacts-list-name">
															Nora S. Vans
											...
											<li>
												<a href="#">
													<img
														class="contacts-list-img"
														src="../assets/admin-lte/img/user6-128x128.jpg"
														alt="User Avatar" />
													<div class="contacts-list-info">
														<span class="contacts-list-name">
															John K.
											...
											<li>
												<a href="#">
													<img
														class="contacts-list-img"
														src="../assets/admin-lte/img/user8-128x128.jpg"
														alt="User Avatar" />
													<div class="contacts-list-info">
														<span class="contacts-list-name">
															Kenneth M.
								...
								<div class="card-body p-0">
									<div class="row text-center m-1">
										...
										<div class="col-3 p-2">
											<img
												class="img-fluid rounded-circle"
												src="../assets/admin-lte/img/user2-160x160.jpg"
												alt="User Image" />
											<a
												class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
												href="#">
										...
										<div class="col-3 p-2">
											<img
												class="img-fluid rounded-circle"
												src="../assets/admin-lte/img/user4-128x128.jpg"
												alt="User Image" />
											<a
												class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
												href="#">
						...
						<div class="card-body p-0">
							<div class="px-2">
								<div class="d-flex border-top py-2 px-1">
									<div class="col-2">
										<img
											src="../assets/admin-lte/img/default-150x150.png"
											alt="Product Image"
											class="img-size-50" />
									</div>
									<div class="col-10">
...
export default {
	...
	setup() {
		onMounted(() => {
			...
			sparklineDataSets.forEach((data, index) => {
				createSparklineChart(`#table-sparkline-${index + 1}`, data);
			});
		...
		const createSparklineChart = (selector, data) => {
			const options = {
				series: [
					{
						data,
